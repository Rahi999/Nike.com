...
const SingleWomenShoes = () => {
  const params = useParams();
  const [SingleWomenShoesData,setSingleWomenShoesData] = useState({});
  ...
  useEffect(() => {
    ...
    .then((res) => {
             setSingleWomenShoesData(res.data);
             setLoading(false)
             })
             .catch((err) => {
                            setError(true)
  ...
  console.log(params)
//   console.log(loading,error,SingleWomenShoesData);
...
export default SingleWomenShoes